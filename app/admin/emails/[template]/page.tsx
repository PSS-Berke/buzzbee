...
export const metadata = {
  title: 'Email preview · Admin · Busby',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="mb-4 bg-white rounded-xl border border-gray-200 p-4 text-sm">
          <dl className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <dt className="text-xs uppercase tracking-wider text-gray-400 font-semibold">Subject</dt>
              <dd className="text-navy mt-1">{subject}</dd>
            </div>
            <div>
              <dt className="text-xs uppercase tracking-wider text-gray-400 font-semibold">Recipient</dt>
              <dd className="text-navy mt-1">{meta.recipient}</dd>
            </div>
            <div>
              <dt className="text-xs uppercase tracking-wider text-gray-400 font-semibold">Trigger</dt>
